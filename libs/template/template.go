...
var databricksTemplates = []Template{
	...
	},
	{
		name:        DLT,
		hidden:      true,
		description: "The DLT template for Delta Live Tables pipelines",
		Reader:      &builtinReader{name: string(DLT)},
		Writer:      &writerWithFullTelemetry{defaultWriter: defaultWriter{name: DLT}},
	},
	{
		name:        DbtSql,
